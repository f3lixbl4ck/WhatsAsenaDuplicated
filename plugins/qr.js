...
// Sentances
const QR_DESC = "Yazıyı QR kodu yapar"
const NEED_TEXT = "*Kelime Girmelisin!*"
...
Asena.addCommand({pattern: 'qr ?(.*)', fromMe: true, desc: QR_DESC}, (async (message, match) => {
    ...
    await message.sendMessage(Buffer.from(webimage.data), MessageType.image, {mimetype: Mimetype.jpg, caption: "Made by Founder"})
